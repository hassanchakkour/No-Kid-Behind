...
const FEATURES = [
  ...
  { icon: PublicRoundedIcon, text: "Accessible anywhere in the world" },
  {
    ...
    text: "Curated courses by verified educators",
  },
];
...
export default function AuthPage() {
  ...
  const handleRegister = async (values: typeof registerInitial) => {
    const data = await registerMutation.mutateAsync({
      ...
      syndicateNumber:
        values.role === "teacher" ? values.syndicateNumber : undefined,
    });
    ...
    >
      ...
      <Box
        sx={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(160deg, #023d2e 0%, #035d45 40%, #1b6b51 100%)",
          p: 6,
        }}
      >
        {/* ── Decorative circles ── */}
        ...
        <Box sx={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Learning is the
            <Box component="span" sx={{ display: "block", color: "#a6f2d1" }}>
              great equalizer.
            </Box>
          </Typography>
          <Typography
          ...
          >
            Join thousands of students and educators on a platform built to make
            quality education accessible to everyone — free, forever.
          </Typography>
              ...
              {(["register", "login"] as const).map((tab) => (
                <Box
                  ...
                  sx={{
                    ...
                    cursor: "pointer",
                    bgcolor:
                      activeTab === tab ? "background.paper" : "transparent",
                    boxShadow:
                      activeTab === tab
                    ...
                    >
                              ...
                              <Box>
                                ...
                                >
                                  ...
                                  <TextField
                                    ...
                                    value={values.caza}
                                    onChange={(e) => {
                                      setFieldValue("caza", e.target.value);
                                      setFieldValue("area", "");
                                      setFieldValue("school", "");
                                    }}
                                    error={touched.caza && !!errors.caza}
                                    helperText={touched.caza && errors.caza}
                                    variant="outlined"
                                    size="small"
                                    fullWidth
                                    sx={inputSx}
                      ...
                      {values.role === "teacher" && (
                        ...
                        >
                          <TextField
                            ...
                            onChange={(e) =>
                              setFieldValue("syndicateNumber", e.target.value)
                            }
                            error={
                              touched.syndicateNumber &&
                              !!errors.syndicateNumber
                            }
                            helperText={
                              touched.syndicateNumber && errors.syndicateNumber
                            }
                            variant="outlined"
                            size="small"
                            fullWidth
                      ...
                      <Button
                        ...
                        sx={{
                          ...
                          borderRadius: "12px",
                          mt: 0.5,
                          boxShadow: "0px 6px 20px 0px rgba(27,107,81,0.25)",
                          "&:hover": {
                            boxShadow: "0px 8px 24px 0px rgba(27,107,81,0.35)",
                          },
                        }}
                      >
