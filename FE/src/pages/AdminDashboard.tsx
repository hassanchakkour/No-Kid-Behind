...
const SIDEBAR_LINKS = [
  ...
  { label: "Videos", path: "/admin/courses" },
  { label: "Wellbeing", path: "/admin/health" },
  { label: "Extra Help", path: "/admin/extra-steps" },
  { label: "Kid to Kid", path: "/admin/kid-to-kid" },
  { label: "Pending Approvals", path: "/admin/pending" },
  { label: "School Admins", path: "/admin/school-admins" },
...
function getTabFromPath(pathname: string): number {
  ...
  if (pathname.startsWith("/admin/school-admins")) return 6;
  if (pathname.startsWith("/admin/analytics")) return 7;
  return 0;
}
...
function OverviewSection() {
  ...
  const topCourses = courses
    ? [...courses].sort((a, b) => b.clicks - a.clicks).slice(0, 5)
    : [];
  ...
  return (
    <Box>
      ...
      >
        ...
        <Typography
          sx={{ fontSize: "0.9375rem", color: "rgba(224,255,238,0.6)", mb: 4 }}
        >
          ...
          <Grid item xs={12} md={5}>
            <Box
              sx={{
                ...
                boxShadow: "0px 2px 12px 0px rgba(42,52,57,0.05)",
                overflow: "hidden",
                height: "100%",
              }}
            >
              <Box
                sx={{
                  ...
                  borderBottom: "1px solid rgba(169,180,185,0.08)",
                }}
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                  <Box
                    sx={{
                      bgcolor: "rgba(27,107,81,0.1)",
                      borderRadius: "8px",
                      p: 0.875,
                      display: "flex",
                    }}
                      ...
                      sx={{
                        ...
                        borderBottom:
                          i < recentUsers.length - 1
                            ? "1px solid rgba(169,180,185,0.07)"
                            : "none",
              ...
              {coursesLoading ? (
                ...
                >
                  {topCourses.map((c, i) => {
                    ...
                    const pct = Math.max(
                      4,
                      Math.round((c.clicks / maxClicks) * 100),
                    );
                    return (
                      <Box key={c.id}>
                        <Box
                        ...
                        >
                          ...
                          >
                            <Box
                              sx={{
                                ...
                                flexShrink: 0,
                                bgcolor:
                                  i === 0 ? "rgba(27,107,81,0.12)" : "#f0f4f7",
                              }}
                            >
                              <Typography
                                sx={{
                                  ...
                                  fontSize: "0.6875rem",
                                  color:
                                    i === 0 ? "primary.main" : "text.disabled",
                                }}
                              >
                                {i + 1}
                              </Typography>
                          ...
                          <Chip
                            ...
                            sx={{
                              bgcolor:
                                i === 0 ? "rgba(27,107,81,0.1)" : "#f0f4f7",
                              color:
                                i === 0 ? "primary.main" : "text.secondary",
                              fontWeight: 700,
                              fontSize: "0.6875rem",
                              flexShrink: 0,
                              ml: 2,
          ...
          {stats && (
            <Grid item xs={12}>
              <Box
                sx={{
                  background:
                    "linear-gradient(135deg, #1b6b51 0%, #035d45 100%)",
                  borderRadius: "14px",
                  p: { xs: 3, md: 4 },
                  position: "relative",
                  overflow: "hidden",
                  ...
                  {[
                    {
                      ...
                      value:
                        stats.totalVisitors > 0
                          ? `${Math.round((stats.totalCourseClicks / stats.totalVisitors) * 100)}%`
                          : "—",
                    },
                    {
                      ...
                      value:
                        stats.totalCourses > 0
                          ? Math.round(
                              stats.totalCourseClicks / stats.totalCourses,
                            ).toLocaleString()
                          : "0",
                    },
                    {
                      ...
                      value:
                        stats.totalProfessionals > 0
                          ? `1:${Math.round((stats.totalUsers - stats.totalProfessionals) / stats.totalProfessionals)}`
                          : "—",
                    },
                    {
                      label: "Total Activity",
                      value: (
                        stats.totalCourseClicks + stats.totalVisitors
                      ).toLocaleString(),
                    },
                  ].map(({ label, value }) => (
    ...
    <Box>
      ...
      {isLoading ? (
        ...
        <TableContainer
          ...
          sx={{
            borderRadius: "10px",
            boxShadow: "0px 2px 12px 0px rgba(42,52,57,0.06)",
            border: "1px solid rgba(169,180,185,0.12)",
          }}
        >
          <Table>
              ...
              {videos && videos.length > 0 ? (
                videos.map((v) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip
                        label={v.clicks.toLocaleString()}
                        size="small"
                        sx={{ bgcolor: `${color}14`, color, fontWeight: 700 }}
                      />
                    </TableCell>
                    <TableCell sx={{ color: "text.secondary" }}>
                      {v.teacher.name}
...
// ── Pending courses review queue ───────────────────────────────────────────
interface PendingCoursesQueueProps {
  pendingCourses: import("../api/courses.api").Course[];
  isLoading: boolean;
...
function PendingCoursesQueue({
  ...
  approving,
  rejecting,
}: PendingCoursesQueueProps) {
  const [page, setPage] = useState(0);
  const rowsPerPage = 5;
  if (isLoading || pendingCourses.length === 0) return null;
  const slice = pendingCourses.slice(
    page * rowsPerPage,
    ...
    >
      ...
      <Box
        sx={{
          ...
          px: 3,
          py: 2,
          borderBottom: "1px solid rgba(196,122,30,0.12)",
          bgcolor: "rgba(196,122,30,0.06)",
        }}
      >
        <Box
          sx={{
            bgcolor: "rgba(196,122,30,0.15)",
            borderRadius: "8px",
            p: 0.875,
            display: "flex",
          }}
        >
          <StarRoundedIcon sx={{ color: "#c47a1e", fontSize: "1rem" }} />
        </Box>
        <Typography
          sx={{
            fontWeight: 700,
      ...
      {slice.map((c, i) => (
        <Box
          ...
          sx={{
            ...
            py: 2,
            borderBottom:
              i < slice.length - 1 ? "1px solid rgba(169,180,185,0.1)" : "none",
            "&:hover": { bgcolor: "rgba(196,122,30,0.03)" },
          }}
        >
          {/* Thumbnail */}
          <Box
            component="a"
            href={`https://youtu.be/${c.youtubeVideoId}`}
            target="_blank"
          ...
          >
            <Box
              component="img"
              src={`https://img.youtube.com/vi/${c.youtubeVideoId}/mqdefault.jpg`}
              alt={c.title}
              sx={{
                width: "100%",
                height: "100%",
          ...
          <Box sx={{ display: "flex", gap: 1, flexShrink: 0 }}>
            <Button
              ...
              sx={{
                ...
                borderRadius: "6px",
                px: 2,
                "&:hover": { bgcolor: "rgba(27,107,81,0.15)" },
              }}
            >
              Approve
            </Button>
            <Button
              ...
              sx={{
                bgcolor: "rgba(159,64,61,0.08)",
                color: "#9f403d",
                fontWeight: 700,
                fontSize: "0.8125rem",
                borderRadius: "6px",
                px: 2,
                "&:hover": { bgcolor: "rgba(159,64,61,0.15)" },
              }}
            >
              Reject
            </Button>
      ...
      {/* Pagination */}
      {pendingCourses.length > rowsPerPage && (
        <TablePagination
          component="div"
...
function ManagementSection() {
  ...
  const { data: courses, isLoading: coursesLoading } = useAdminCourses();
  const { data: stats, isLoading: statsLoading } = useAdminStats();
  const { data: kidCourses, isLoading: kidLoading } = useCourses({
    isKidToKid: true,
  });
  const { data: pendingKidTutors, isLoading: pendingLoading } =
    usePendingKidTutors();
  const { data: pendingCourses, isLoading: pendingCoursesLoading } =
    usePendingCourses();
  ...
  const createSchoolAdmin = useCreateSchoolAdmin();
  ...
  const [cpTarget, setCpTarget] = useState<{ id: string; name: string } | null>(
    null,
  );
  ...
  return (
    <Box>
      ...
      >
        ...
        <Tab
          label={`Pending${pendingKidTutors?.length ? ` (${pendingKidTutors.length})` : ""}`}
        />
        <Tab label="School Admins" />
        <Tab label="Analytics" />
      </Tabs>
      ...
      {tab === 2 && (
        <Box>
          <PendingCoursesQueue
            ...
            onApprove={(id) => approveCourse.mutate(id)}
            onReject={(id) => rejectCourse.mutate(id)}
            approving={approveCourse.isPending}
            rejecting={rejectCourse.isPending}
          />
          <VideoSection
      ...
      {tab === 3 && (
        <Box>
          ...
          />
          <VideoSection
            label="Extra Help Videos"
            icon={AccessibilityNewRoundedIcon}
            color="#6b3e8e"
            filter={{ isSpecialNeeds: true }}
            dialogTitle="Add Extra Help Video"
            dialogDesc="Add a YouTube video tailored for students who learn with extra help."
          />
        </Box>
      )}
                ...
                <TableBody>
                  {kidCourses && kidCourses.length > 0 ? (
                    ...
                    <TableRow>
                      ...
                      >
                        No kid-to-kid courses yet. Flag a student as a student
                        teacher to let them start adding courses.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
        ...
        (pendingLoading ? (
          ...
          <Box>
            ...
            >
              ...
              {pendingKidTutors && (
                <Chip
                  label={pendingKidTutors.length}
                  size="small"
                  sx={{
                    bgcolor: "rgba(196,122,30,0.12)",
                    color: "#c47a1e",
                    fontWeight: 700,
                  }}
                />
            ...
            >
              <Table>
                ...
                <TableBody>
                  {pendingKidTutors && pendingKidTutors.length > 0 ? (
                    pendingKidTutors.map((u) => (
                      <TableRow
                        key={u.id}
                        hover
                        sx={{ "&:last-child td": { border: 0 } }}
                ...
                <TableBody>
                  {users.filter((u) => u.role === "school_admin").length > 0 ? (
                          ...
                          <TableCell align="right">
                            <Tooltip title="Change password">
                              <IconButton
                                size="small"
                                onClick={() => {
                                  setCpTarget({ id: u.id, name: u.name });
                                  setCpPassword("");
                                  setCpShowPass(false);
                                  setCpError("");
                                }}
                    ...
                    <TableRow>
                      ...
                      >
                        No school admins yet. Use the button above to create
                        one.
                      </TableCell>
                    </TableRow>
                  )}
      ...
      >
        <DialogTitle sx={{ fontWeight: 800, fontSize: "1.125rem", pb: 0.5 }}>
          Create School Admin
        </DialogTitle>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <Box sx={{ display: "flex", gap: 1.5 }}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setSaForm((f) => ({ ...f, username: e.target.value }))
                }
                size="small"
                fullWidth
                required
            ...
            <TextField
              ...
              value={saForm.school}
              onChange={(e) =>
                setSaForm((f) => ({ ...f, school: e.target.value }))
              }
              size="small"
              fullWidth
              required
            ...
            <TextField
              ...
              value={saForm.email}
              onChange={(e) =>
                setSaForm((f) => ({ ...f, email: e.target.value }))
              }
              size="small"
              fullWidth
            />
            <TextField
              ...
              onChange={(e) =>
                setSaForm((f) => ({ ...f, password: e.target.value }))
              }
              size="small"
              fullWidth
              required
        ...
        <DialogActions sx={{ px: 3, pb: 3, gap: 1 }}>
          ...
          <Button
            variant="contained"
            disabled={createSchoolAdmin.isPending}
            onClick={async () => {
              setSaError("");
              const { username, name, password, school } = saForm;
              if (!username || !name || !password || !school) {
                setSaError("Name, username, password and school are required.");
                return;
              }
              try {
                await createSchoolAdmin.mutateAsync({
                  username,
                  name,
                  password,
                  school,
                  email: saForm.email || undefined,
                });
                setSaSuccess(
                  `School admin @${username} created for ${school}.`,
                );
                setSaOpen(false);
                setSaForm({
                  username: "",
          ...
          >
            {createSchoolAdmin.isPending ? "Creating…" : "Create"}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent sx={{ pt: "12px !important" }}>
          ...
          >
            Set a new password for <strong>{cpTarget?.name}</strong>.
          </Typography>
          {cpError && (
            <Alert severity="error" sx={{ mb: 2, borderRadius: "8px" }}>
              {cpError}
        ...
        <DialogActions sx={{ px: 3, pb: 3, gap: 1 }}>
          ...
          <Button
            ...
            onClick={async () => {
              setCpError("");
              if (!cpPassword || cpPassword.length < 6) {
              ...
              try {
                ...
                setSaSuccess(`Password updated for ${cpTarget!.name}.`);
                setCpTarget(null);
              } catch (err: any) {
                setCpError(
                ...
                {usersByRole ? (
                  ...
                  >
                    {[
                      {
                        label: "Students",
                        count: usersByRole.student,
                        color: "#1b6b51",
                      },
                      {
                        label: "Kid Tutors",
                        count: usersByRole.kid_tutor,
                        color: "#c47a1e",
                      },
                      {
                        label: "Professionals",
                        count: usersByRole.professional,
                        color: "#475569",
                      },
                      {
                        label: "Admins",
                      ...
                      const total =
                        usersByRole.student +
                          usersByRole.kid_tutor +
                          usersByRole.professional +
                          usersByRole.admin || 1;
                      ...
                      return (
                        <Box key={course.id}>
                          ...
                          >
                            ...
                            <Chip
                              label={`${course.clicks.toLocaleString()} views`}
                              size="small"
                              sx={{
                                bgcolor: "rgba(27,107,81,0.08)",
                                color: "primary.main",
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  <Box
                    sx={{ display: "flex", flexDirection: "column", gap: 3 }}
                  >
                    {stats.privateSchoolStats.map(
                      ({ school, students, kidTutors }) => (
                        <Box
                          key={school}
                          sx={{
                            p: 2.5,
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  {stats.madristiClicks.length === 0 ? (
                    ...
                    >
                      No Madristi clicks recorded yet.
                    </Typography>
                  ) : (
                    <Box
                      sx={{
                        ...
                        return (
                          <Box key={school}>
                            ...
                            >
                              ...
                              <Chip
                                label={`${clicks.toLocaleString()} clicks`}
                                size="small"
                                sx={{
                                  bgcolor: "rgba(27,107,81,0.08)",
                                  color: "primary.main",
