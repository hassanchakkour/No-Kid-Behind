...
import wellbeingVideo from "../demo-videos/wellbeing.mp4";
...
export default function HealthPage() {
  ...
  const filtered = (Array.isArray(allVideos) ? allVideos : []).filter((v) => {
    const subjectMatch =
      !subject || v.subject.toLowerCase().includes(subject.toLowerCase());
    const searchMatch =
      !search ||
            ...
            <Box>
              ...
              <Button
                ...
                sx={{
                  mt: 2,
                  color: "#e8f4ff",
                  borderColor: "rgba(166,210,255,0.5)",
                  border: "1px solid",
                  borderRadius: "8px",
                  px: 2,
                  py: 0.75,
      ...
      >
        <Box sx={{ maxWidth: 1280, mx: "auto", display: "flex", gap: 2, alignItems: "center", flexWrap: "wrap" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, color: "text.secondary", flexShrink: 0 }}>
            ...
            {activeFilters > 0 && (
              <Chip label={activeFilters} size="small" sx={{ bgcolor: "#2e5d8e", color: "#e8f4ff", fontWeight: 700, fontSize: "0.625rem", height: 18, ml: 0.5 }} />
            )}
          </Box>
